...
@.env.1 = private unnamed_addr constant [64 x i8] c"bridge-implementation=new,nursery-size=32m,soft-heap-limit=256m\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [15 x i8] c"com.appbanhang\00", align 1
